...
Next, consider the correlations among the variables in the dataset. Mileage is most strongly correlated with wt, cyl and disp. These variables are also strongly positevely correlated to each other. Strong correlations among predictor variables might lead to confounders in the regression.
